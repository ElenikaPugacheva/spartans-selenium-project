...
public class UploadPhoneNumberProfile {
    public static void main(String[] args) {
        ...
        WebElement successUpdateMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[text()='Personal Information Updated Successfully']")));
